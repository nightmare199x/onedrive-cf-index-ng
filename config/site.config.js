...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'truongleanhdung@hotmail.com',
  ...
  protectedRoutes: ['/-- Private folder', '/Private folder', '/- Tools'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:truongleanhdung@hotmail.com',
  ...
  opds: {
    enabled: true,
    title: "Naimeee's OneDrive",
    description: 'My Naimeee OPDS Librar',
